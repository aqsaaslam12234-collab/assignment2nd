export default function UserProfile() {
  return (
    <div className="min-h-screen w-full p-4 flex bg-linear-to-br from-teal-800 to-teal-400  items-center justify-center">
      <div className="bg-white shadow-lg rounded-2xl p-8 max-w-md  w-full">
        <div className="flex items-center gap-6">
          <div className="relative  flex">
            <div className="size-32 rounded-full bg-linear-to-br from-orange-400 to-orange-600 overflow-hidden">
              <img
            ...
            <div className="fiex-1">
              ...
              <p className="text-xl text-gray-500 pl-6 font-medium">Website Developer</p>
            </div>
          </div>
        </div>
      </div>
